...
namespace NSprites.Authoring
{
    public static partial class BakerExtensions
    {
        ...
        /// </summary>
        public static void BakeSpriteRender<TAuthoring>(this Baker<TAuthoring> baker, in Entity entity, TAuthoring authoring, in float4 uvAtlas, in float2 pivot, in float2 scale, in UnityEngine.Color color)
             where TAuthoring : Component
        {
            if (baker == null)
            {
